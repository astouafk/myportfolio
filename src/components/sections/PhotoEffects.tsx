...
//       void main() {
//         float alpha = 0.5 + 0.5 * sin(vUv.x * 10.0 + time);
...
//     const now = Date.now()
//     // N'animer que toutes les 50ms (20fps) pour économiser le CPU
//     if (now - initialTimeRef.current < 50) return
...
// // Composant optimisé avec vérification d'intersection
// const PhotoEffects = () => {
//   const containerRef = useRef<HTMLDivElement>(null)
//   const [isVisible, setIsVisible] = useState(false)

//   // Utiliser un observateur d'intersection pour ne rendre que lorsque visible
//   useEffect(() => {
...
//   return (
//     <div ref={containerRef} className="absolute inset-[-50px]">
//       {isVisible && (
//         <Canvas
...
// export default memo(PhotoEffects)
