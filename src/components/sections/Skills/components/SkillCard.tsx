...
//       }}
//       className="w-36 h-36 md:w-40 md:h-40 flex-shrink-0 m-4 relative"
//     >
//       <div 
//         className="absolute inset-0 rounded-xl bg-gradient-to-br from-white/10 to-white/5 
//         backdrop-blur-md border border-white/10 overflow-hidden shadow-lg hover:border-[#4ADE80]/40 
...
//             style={{ backgroundColor: `${skill.color}30` || '#4ADE8030' }}
//           >
//             <div 
